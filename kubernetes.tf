...
resource "aws_key_pair" "kubernetes-devterraformaiza-com-d2800f06f0847f8ea050e07345b1fa52" {
  key_name   = "kubernetes.devterraformaiza.com-d2:80:0f:06:f0:84:7f:8e:a0:50:e0:73:45:b1:fa:52"
  public_key = "${file("${path.module}/data/aws_key_pair_kubernetes.devterraformaiza.com-d2800f06f0847f8ea050e07345b1fa52_public_key")}"
}
...
resource "aws_launch_configuration" "bastions-devterraformaiza-com" {
  ...
  key_name                    = "${aws_key_pair.kubernetes-devterraformaiza-com-d2800f06f0847f8ea050e07345b1fa52.id}"
